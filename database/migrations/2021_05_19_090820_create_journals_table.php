...
class CreateJournalsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('journals', function (Blueprint $table) {
            ...
            $table->text(Journal::FIELD_DEBIT_ACCOUNT_ID)->nullable();
            $table->text(Journal::FIELD_DEBIT_ACCOUNT_NAME)->nullable();
            $table->text(Journal::FIELD_CREDIT_ACCOUNT_ID)->nullable();
            $table->text(Journal::FIELD_CREDIT_ACCOUNT_NAME)->nullable();
            $table->text(Journal::FIELD_REFERENCE)->nullable();
            $table->text(Journal::FIELD_ADJUSTED_ENTRY)->nullable();
            $table->text(Journal::FIELD_SUB_PROJECT_ID)->nullable();
