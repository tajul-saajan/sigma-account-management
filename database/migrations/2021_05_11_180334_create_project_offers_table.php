...
class CreateProjectOffersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_offers', function (Blueprint $table) {
            ...
            $table->dateTime(ProjectOffer::FIELD_E_BILL_SUBMISSION_DATE)->nullable();
            $table->dateTime(ProjectOffer::FIELD_HARD_COPY_SUBMISSION_DATE)->nullable();
            $table->dateTime(ProjectOffer::FIELD_MONEY_RECEIVE_DATE)->nullable();
            ...
            $table->dateTime(ProjectOffer::FIELD_INSERT_TIME)->nullable();
