<template>
    <div class="flex-col  justify-center items-center">
        ...
        <div class="flex justify-center mt-4">
            ...
            <form @submit.prevent="updateMeeting" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                <p class="text-gray-800 font-bold text-center">Update Meeting</p>
...
export default {
    ...
    created() {
        this.axios.get(process.env.MIX_PUBLISH_APP_URL + 'meetings/edit/' + this.$route.params.id)
            .then(response => {
                ...
                this.selectedUsers = response.data[1]
    ...
    methods: {
        updateMeeting() {
            ...
            this.axios
                .post(process.env.MIX_PUBLISH_APP_URL + `meetings/update/`+this.$route.params.id, data)
                .then((response) => {
