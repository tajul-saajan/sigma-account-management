<template>
 <div class="flex-col  justify-center items-center">
        ...
        <div class="flex justify-center mt-4">
            ...
            >
                <caption slot="head" class="text-white text-2xl bg-gray-600 p-4 font-bold text-center">All Applications
                </caption>
...
export default {
    ...
    methods: {
        ...
        getResults(page) {
            ...
            this.axios.get(process.env.MIX_PUBLISH_APP_URL+'applications?page=' + page)
                .then(response => {
