<template>
    <div class="flex-col  justify-center items-center">
        ...
        <div class="flex justify-center mt-4">
            ...
            <form @submit.prevent="addApplication" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                <p class="text-gray-800 font-bold text-center">Apply For Leave</p>
...
export default {
    ...
    methods: {
        addApplication() {
            this.axios
                .post(process.env.MIX_PUBLISH_APP_URL+`applications/add`, this.application)
                .then((response) => {
