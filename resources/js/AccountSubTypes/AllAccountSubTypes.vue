    ...
    <div class="flex-col  justify-center items-center">
        ...
        <div class="flex justify-center mt-4">
            <table class="border-2 rounded-lg bg-white flex-col items-center justify-center">
                <caption class="text-white text-2xl bg-gray-600 p-4 font-bold text-center">All Account Sub Types</caption>
                ...
                <tr v-for="(accountSubType,id) in accountSubTypes.data" :key="id">
                    ...
                    <td class="px-6 py-4 text-center">{{ accountSubType.description }}</td>
                    <td class="px-6 py-4 text-center flex justify-between">
                        <div class="flex " role="group">
                            <router-link :to="{name: 'editAccountSubTypes', params: { id: accountSubType.id }}"
        ...
        <pagination class="flex justify-evenly text-2xl m-2 p-4 bg-gray-200 rounded-lg"
                    :data="accountSubTypes" @pagination-change-page="getResults">
            <span slot="prev-nav">
...
export default {
    ...
    methods: {
        ...
        getResults(page) {
            ...
            this.axios.get('http://po-management.test/api/accountSubTypes?page=' + page)
                .then(response => {
