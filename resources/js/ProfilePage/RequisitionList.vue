<template>
    ...
    <div class="flex justify-center mt-4">
        ...
        >
            <caption slot="head" class="text-white text-2xl bg-gray-600 p-4 font-bold text-center">My Requisitions
            </caption>
...
export default {
    ...
    methods: {
        ...
        getResults(page) {
            ...
            this.axios.get(process.env.MIX_PUBLISH_APP_URL + 'auth/requisitions?page=' + page)
                .then(response => {
