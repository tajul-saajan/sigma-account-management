<template>
    <div class="flex-col  justify-center items-center">
        ...
        <div class="flex justify-center mt-4">
            ...
            <form @submit.prevent="addTransaction" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                ...
                <div class="mt-2">
                    ...
                    <input type="file" class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded"
                           :disabled="transaction.cash_or_check !=='cheque'" @change="setChequeImage"
                    >
                </div>
...
export default {
    ...
    methods: {
        ...
        addTransaction() {
            ...
            data.append('check_image', this.chequeImage)
            data.append('invoice_file', this.invoiceFile)
            const json = JSON.stringify({transaction:this.transaction})
            data.append('transaction', json)
            this.axios
                .post(process.env.MIX_PUBLISH_APP_URL + `transactions/add`, data)
                .then((response) => {
